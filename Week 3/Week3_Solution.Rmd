...
median(sim_streak$length)    #The typical streak length is 0

max(sim_streak$length)       #The maximum streak I got is between 4 to 6, in one case I got 7. However, it can varies when you perform the sampling since it is a random process. But, the distribution appears somewhat similar. So, we can say that there is no evidence for Kobe Bryant's hot hand.
...
Answer: The concepts that is mostly covered in this lab is Bayesian Inference and how to calculate sampling in R. I would love to see Conditional Probability being added in this lab.          
